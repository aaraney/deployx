...
func convertVolumeToMount(
	volume composego.ServiceVolumeConfig,
	stackVolumes composego.Volumes,
	namespace Namespace,
) (mount.Mount, error) {
	switch volume.Type {
	case "volume", "":
...
func handleBindToMount(volume composego.ServiceVolumeConfig) (mount.Mount, error) {
	result := createMountFromVolume(volume)
...
func handleTmpfsToMount(volume composego.ServiceVolumeConfig) (mount.Mount, error) {
	result := createMountFromVolume(volume)
...
func handleNpipeToMount(volume composego.ServiceVolumeConfig) (mount.Mount, error) {
	result := createMountFromVolume(volume)
